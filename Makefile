...
#SRCS
SRCS = $(addprefix $(SRCPATH)/, builtins_1.c builtins_2.c environment.c environment_2.c main.c main_loop.c executable_builtin.c exit_error_manager.c signal_handler.c)

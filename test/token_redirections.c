...
/*
** redirections() translate the symbol of the first character from the given line
...
** path.
** Once all data is fetched to uses open accordingly, redirections() records the
